  ...
  return (
    <div className="bg-white shadow-lg p-4 flex flex-col justify-between mb-3">
      ...
      <div className=" flex justify-around">
        <button className="bg-blue-500 hover:bg-blue-600 outline outline-1 font-semibold py-2 px-4 hover:bg-fontColor hover:text-white ">Buy Now</button>
        <button className="bg-blue-500 hover:bg-blue-600 outline outline-1 font-semibold py-2 px-4 hover:bg-fontColor hover:text-white ">Add to Cart</button>
      </div>
    </div>
  );
}
